...
from wallpaper_manager.detect.paths import cursor_settings_path
...
class CursorAdapter:
    ...
    def settings_path(self) -> Path:
        return self._path_override if self._path_override is not None else cursor_settings_path()
    ...
    def extension_installed(self) -> bool:
        return any(
            Path.home().joinpath(".cursor", "extensions").glob(
